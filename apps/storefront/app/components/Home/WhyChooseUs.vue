<template>
  <section
    class="w-full relative overflow-hidden flex items-center min-h-[480px] bg-none max-lg:bg-[#0d2247] max-lg:border-b-6 max-lg:border-brand-orange max-lg:p-0 lg:bg-[url('/Images/why-choose-us-bg.webp')] lg:bg-cover lg:bg-right lg:bg-no-repeat"
  >
    <div
      class="w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center"
    >
      <!-- Content Container -->
      <div
