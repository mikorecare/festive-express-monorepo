<template>
  <div class="error-page">
    ...
    <section role="region" aria-label="Hero section" class="page-hero snow-bg">
      <div class="hero-overlay">
        <div class="container">
          <div class="hero-content">
            <h1>{{ is404 ? "404" : "ERROR" }}</h1>
            <p class="breadcrumb">
              HOME / {{ is404 ? "PAGE NOT FOUND" : "SOMETHING WENT WRONG" }}
            </p>
          </div>
        </div>
      </div>
    ...
    <!-- Error Body -->
    <div
      class="container max-w-[640px] text-center px-5 py-5 pt-15 pb-25 mx-auto"
    >
