<template>
  <div class="packages-page min-h-screen bg-white font-sans text-slate-800">
      ...
      <div class="hero-overlay absolute inset-0 bg-black/40 z-10">
        ...
        >
          <div class="hero-content text-center max-w-2xl mx-auto">
            <h1
              v-fade
              class="text-3xl md:text-5xl font-extrabold tracking-tight text-white mb-4"
            >
    ...
    <div v-if="loading" class="text-center py-16">
      <p class="text-lg text-slate-600 animate-pulse">
        Loading package programs...
      </p>
    </div>
    ...
    <div v-else class="package-sections-container flex flex-col">
      <section
        ...
        :class="[
          ...
          { 'bg-alt bg-slate-50': getPackageSlug(pkg.name) === 'jolly' },
        ]"
      >
        <div class="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <div
              class="package-price font-color-orange text-3xl md:text-4xl font-extrabold text-amber-500"
            >
              ${{ pkg.price || "0.00" }}
            </div>
          </div>
          ...
          >
            ...
            <div
              class="media-column lg:col-span-7 flex flex-col bg-white rounded-xl overflow-hidden shadow-sm border border-slate-100"
            >
              <div
                class="image-wrapper relative bg-slate-100 cursor-pointer overflow-hidden group"
              ...
              >
                ...
                <div
                  class="lights-badge absolute right-4 bottom-4 w-16 h-16 rounded-full bg-amber-500 flex items-center justify-center z-20 shadow-lg"
                  aria-hidden="true"
                >
                  <img
                ...
                >
                  <span
                    ...
                    :class="
                      activeInclusions[pkg.id] === spot.key
                        ? 'bg-amber-500 scale-125'
                        : 'bg-slate-900 group-hover/spot:bg-amber-500 group-hover/spot:scale-110'
                    "
                  ></span>
                  <span
                ...
                >
                  ...
                  <div
                    class="hotspot-popup-img-wrap w-full h-24 bg-slate-100 p-2 flex items-center justify-center"
                  ...
                  <div class="hotspot-popup-body p-2.5 text-center">
                    <h4
                      class="hotspot-popup-title text-xs font-bold text-slate-900 leading-tight"
                    >
              ...
              >
                <h4 class="color-title text-sm font-bold text-slate-900 mb-3">
                ...
                <div class="color-options flex justify-center flex-wrap gap-3">
                  <div
                    ...
                    :class="{
                      'active border-amber-500 bg-amber-50':
                        selectedColors[pkg.id] === color.name,
                  ...
                  >
                    <div
                      class="color-swatch w-8 h-8 rounded-full border-2 border-slate-300 shadow-inner"
                      :style="{ backgroundColor: color.hex }"
                    ></div>
                    <span
                      class="color-label text-xs font-semibold text-slate-700"
                      >{{ color.name }}</span
                    >
                  </div>
                </div>
            ...
            <div class="details-column lg:col-span-5 flex flex-col gap-6">
              ...
              <div class="inclusions-block mt-4">
                ...
                <ul
                  ...
                  class="inclusions-list space-y-3 list-none p-0 m-0"
                >
                  <li
                  ...
                  >
                    <div
                      ...
                      :key="oIndex"
                      class="feature-line flex items-center gap-2.5 p-2.5 bg-white border border-slate-200 rounded-xl cursor-pointer hover:border-[#F49321] hover:bg-[#fff7ed] transition-colors"
                      @click="highlightInclusion(pkg.id, option.name)"
                    >
                      <span
                        v-if="!option.image_url"
                        class="check-icon text-emerald-500 font-bold"
                        >✔</span
                      >
                      <img
                        v-if="option.image_url"
              ...
              <button
                @click="scrollToSpecs"
                class="info-btn group inline-flex items-center justify-center gap-2 bg-transparent text-slate-900 border-2 border-slate-900 px-6 py-3 text-sm font-semibold rounded-lg cursor-pointer hover:bg-slate-900 transition-all duration-200"
              >
                For More Product Information
                <span
                  class="arrow-down text-base transition-transform duration-200 group-hover:translate-y-1"
                  >↓</span
                >
              </button>

              <div
                class="p-info-card p-4 bg-blue-50 border border-dashed border-blue-200 rounded-xl"
              >
                <p
                  class="info-text m-0 text-xs sm:text-sm text-blue-800 flex items-start gap-2.5 leading-relaxed"
                >
                  <i
                    class="fas fa-info-circle text-blue-500 text-base flex-shrink-0 mt-0.5"
                  ></i>
              ...
              <div class="action-block">
                ...
                >
                  <span
                    v-if="addingToCartId === pkg.id"
                    class="button-loader inline-flex items-center justify-center gap-2"
                  >
            ...
            >
              ...
              <div class="product-body p-6 flex flex-col flex-grow">
                ...
                <div class="spec-block mb-4">
                  <h4
                    class="text-base font-bold text-[#1C2D5B] mb-2.5 pb-0.75 border-b-2 border-[#F49321] inline-block"
                  >
                    Features
                  </h4>
                  <ul
                ...
                <div class="spec-block mt-auto">
                  ...
                  >
                    <div>
                      <span class="font-bold text-slate-900">Voltage:</span>
                      120V
                    </div>
                    <div>
                    ...
                    <div>
                      <span class="font-bold text-slate-900">Kelvin:</span>
                      3000K
                    </div>
                    <div>
                    ...
                    <div>
                      <span class="font-bold text-slate-900">Dimmable:</span>
                      Yes
                    </div>
                    <div>
                      <span class="font-bold text-slate-900">Diode Count:</span>
                      3
                    </div>
                  </div>
                </div>
              ...
              <div class="product-body p-6 flex flex-col flex-grow">
                ...
                <div class="spec-block mt-auto">
                  ...
                  >
                    ...
                    <div>
                      <span class="font-bold text-slate-900">Length:</span> 17
                      ft total
                    </div>
                    <div>
                      <span class="font-bold text-slate-900">Wire:</span> 20
                      Gauge Green
                    </div>
                    <div>
                      <span class="font-bold text-slate-900">Voltage:</span>
              ...
              <div class="product-body p-6 flex flex-col flex-grow">
                ...
                <div class="spec-block mt-auto">
                  ...
                  >
                    ...
                    <div>
                      <span class="font-bold text-slate-900">Frame Dia:</span>
                      14 in
                    </div>
                    <div>
                      <span class="font-bold text-slate-900">Weight:</span> 6
                      lbs
                    </div>
                    <div>
              ...
              <div class="product-body p-6 flex flex-col flex-grow">
                ...
                <div class="spec-block mt-auto">
                  ...
                  >
                    ...
                    <div>
                      <span class="font-bold text-slate-900">Loop Count:</span>
                      4
                    </div>
                    <div>
              ...
              <div class="product-body p-6 flex flex-col flex-grow">
                ...
                <div class="spec-block mt-auto">
                  ...
                  >
                    ...
                    <div>
                      <span class="font-bold text-slate-900">Bulb Type:</span>
                      C9 LED
                    </div>
                    <div>
            ...
            >
              ...
              <div class="product-body p-6 flex flex-col flex-grow">
                ...
                <div class="spec-block mt-auto">
                  ...
                  >
                    <div>
                      <span class="font-bold text-slate-900">Height:</span> 36
                      in
                    </div>
                    <div>
                    ...
                    <div>
                      <span class="font-bold text-slate-900">Lead Wire:</span>
                      120 in
                    </div>
                    <div>
