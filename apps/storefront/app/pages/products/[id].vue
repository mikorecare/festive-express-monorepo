  ...
  <div>
            ...
            <div v-if="product?.is_package" class="package-badge">
              ...
              <div
                ...
                :class="{
                  ...
                  featured: !['joy', 'jolly', 'merry'].some((n) =>
                    product?.name?.toLowerCase().includes(n),
                  ),
                }"
              >
              ...
              <div class="image-wrapper" @click="openLightbox">
                ...
                >
                  <button
                    type="button"
                    class="hotspot-close"
                    @click.stop="activeInclusion = null"
                  >
                    ×
                  </button>
                  ...
                  <div class="hotspot-popup-body">
                    ...
                    <p v-if="activeSpot.desc" class="hotspot-popup-desc">
                      {{ activeSpot.desc }}
                    </p>
                  </div>
                </div>
          ...
          <div class="product-info-right">
            ...
            <div class="p-info-card">
              <p class="d-flex align-items-center gap-3 mb-0">
                ...
                Professional commercial-grade LEDs with expert installation
                included.
              </p>
            </div>
          ...
          <div class="themes-header">
            <div class="step-label">
              ...
              <h2>
                ...
                <span class="alacarte-tag">A LA CARTE</span>
              </h2>
            </div>
          ...
          <div class="alacarte-list">
            ...
            >
              <div class="alacarte-group-header">
                <h3>{{ group.name }}</h3>
                <span v-if="group.hasLights" class="lights-badge"
                  >+ lights</span
                >
              </div>
              ...
              <div class="alacarte-row">
                ...
                <label
                  ...
                  class="lights-check"
                >
                  <input type="checkbox" v-model="alacarteLights[group.id]" />
                  Add lights (+${{
                    selectedAlacarteItem(group.id)?.lightsPrice
                  }})
                </label>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row g-5">
          ...
          <div class="col-md-6 product-info-right">
            <div class="price mb-3">${{ product?.price || "0.00" }}</div>
            ...
            <!-- Variations -->
            <div
              v-if="product?.has_variations && product?.variations?.length"
              class="variations-box mb-4"
            >
              <div
                v-for="(variation, vIndex) in product.variations"
                :key="vIndex"
              ...
              >
                ...
                <div class="d-flex flex-wrap gap-2">
                  <button
                    ...
                    :class="{
                      active: selectedVariations[vIndex] === option.name,
                    }"
    ...
    <section class="explore-packages py-5 d-none">
      <div class="container">
        ...
        >
          <div>
            ...
            <p class="text-muted mb-0">
              Find the perfect holiday lighting display for your home.
            </p>
          </div>
        ...
        <!-- Dynamic Cards -->
        <div class="row g-4">
          <div v-for="pkg in packageProducts" :key="pkg.id" class="col-md-6">
            <div class="package-card h-100">
              ...
              <div class="package-body">
                ...
                <p class="package-desc">
                  {{
                    pkg.description ||
                    "Professional holiday lighting package with expert installation."
                  }}
                </p>
...
const isPackageProduct = computed(() => {
  const name = product.value?.name?.toLowerCase() || "";
  return (
    name.includes("joy") || name.includes("jolly") || name.includes("merry")
  );
});
...
const designCollections = [
  {
    ...
    designs: [
      {
        id: 1,
        name: "Crimson Seasons",
        image: "/Images/themes/crimson-seasons.png",
        collection: "Contemporary",
      },
      {
        id: 2,
        name: "Northern Seasons",
        image: "/Images/themes/northern-seasons.png",
        collection: "Contemporary",
      },
      {
        id: 3,
        name: "Winter Seasons",
        image: "/Images/themes/winter-seasons.png",
        collection: "Contemporary",
      },
    ],
  },
    ...
    designs: [
      {
        id: 4,
        name: "Scarlet Snow",
        image: "/Images/themes/scarlet-snow.png",
        collection: "Traditional",
      },
      {
        id: 5,
        name: "Crimson Cheer",
        image: "/Images/themes/crimson-cheer.png",
        collection: "Traditional",
      },
      {
        id: 6,
        name: "Midnight Jewels",
        image: "/Images/themes/midnight-jewels.png",
        collection: "Traditional",
      },
    ],
  },
    ...
    designs: [
      {
        id: 7,
        name: "Diamonds",
        image: "/Images/themes/diamonds.png",
        collection: "Minimalistic",
      },
      {
        id: 8,
        name: "Champagne Toast",
        image: "/Images/themes/champagne-toast.png",
        collection: "Minimalistic",
      },
      {
        id: 9,
        name: "Winter Luxe",
        image: "/Images/themes/winter-luxe.png",
        collection: "Minimalistic",
      },
    ],
  },
    ...
    designs: [
      {
        id: 10,
        name: "Frosted Nights",
        image: "/Images/themes/frosted-nights.png",
        collection: "Trendy",
      },
      {
        id: 11,
        name: "Enchanted Forest",
        image: "/Images/themes/enchanted-forest.png",
        collection: "Trendy",
      },
      {
        id: 12,
        name: "Heavenly Bordeaux",
        image: "/Images/themes/heavenly-bordeaux.png",
        collection: "Trendy",
      },
    ],
  },
...
const alacarteGroups: AlacarteGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: "poinsettia",
        label: '6 1/2 pot x 18" tall w/ deco cover',
        price: 21.95,
      },
    ],
  },
