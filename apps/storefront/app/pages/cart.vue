    ...
    <div class="container mx-auto max-w-[1280px] px-5 py-10">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-8">
          ...
          <div
            v-else-if="loading"
            class="bg-white rounded-2xl p-12 text-center text-gray-500"
          >
            Loading cart…
          </div>
        ...
        <div class="lg:col-span-4">
          <div class="bg-white rounded-2xl p-7 shadow-sm sticky top-24">
            ...
            <div
              ...
              class="flex justify-between text-gray-500 mb-3"
            >
            ...
            >
              ...
              <span class="font-semibold text-gray-800"
                >−${{ discountAmount(subtotal).toFixed(2) }}</span
              >
            </div>
            ...
            <div class="space-y-2 mb-5">
              ...
              <p v-if="promoError" class="text-red-500 text-xs">
                {{ promoError }}
              </p>
        ...
        <div class="flex items-center gap-3 text-[#0c2340]">
          ...
          <div>
            ...
            <small class="text-gray-400 text-xs"
              >256-bit SSL encrypted payments</small
            >
          </div>
        </div>
        <div class="flex items-center gap-3 text-[#0c2340]">
          ...
          <div>
            ...
            <small class="text-gray-400 text-xs"
              >CLIPA-certified professionals</small
            >
          </div>
        </div>
        <div class="flex items-center gap-3 text-[#0c2340]">
          ...
          <div>
            ...
            <small class="text-gray-400 text-xs"
              >Season-long maintenance included</small
            >
          </div>
        </div>
      </div>
