      ...
      "/**": {
        headers: {
          ...
          "Content-Security-Policy":
            "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://jsdelivr.net https://pages.dev https://posthog.com https://*.posthog.com https://challenges.cloudflare.com; worker-src 'self' blob: https://pages.dev; connect-src 'self' https://pages.dev https://*.posthog.com https://posthog.com https://challenges.cloudflare.com; style-src 'self' 'unsafe-inline' https://googleapis.com https://pages.dev https://challenges.cloudflare.com; font-src 'self' https://gstatic.com https://cdnjs.cloudflare.com; img-src 'self' data: https://*.posthog.com; frame-src 'self' https://pages.dev https://challenges.cloudflare.com;",
        },
      },
    },
  },
