    ...
    <main class="admin-main2">
        ...
        <div class="content-grid">
            ...
            <div class="add-form">
              ...
              <form @submit.prevent="createCategory">
                  <div class="form-section mt-4">
                      ...
                      <input v-model="newCategory.name" type="text" placeholder="e.g. Patriotic" required @input="generateSlug">
                  </div>

                  <div class="form-section mt-4">
                      <label class="form-label">Slug</label>
                      <input v-model="newCategory.slug" type="text" placeholder="patriotic">
                  </div>

                  <div class="form-section mt-4">
                      <label class="form-label">Description</label>
                      <textarea v-model="newCategory.description" rows="4" placeholder="Category description..."></textarea>
                  </div>
            ...
            <div class="categories-list">
              ...
              <div v-for="(category, index) in paginatedCategories" :key="category.id" class="category-item" :class="{ 'even-row': index % 2 === 0 }">
                  ...
                  <div class="category-actions">
                    <button @click="editCategory(category)" class="btn-edit mr-2">Edit</button>
...
.add-form h3, .categories-list h3 {
  margin-bottom: 24px;
  color: #0c2340;
  font-size: 1.4rem;
}
