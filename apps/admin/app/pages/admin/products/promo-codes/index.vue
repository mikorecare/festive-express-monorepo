  ...
  <div class="p-6 space-y-6 bg-slate-50 min-h-screen">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div class="lg:col-span-5">
        <div class="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
          ...
          <div class="space-y-4">
            ...
            <div>
              <label class="block text-sm font-semibold text-navy mb-2">Applies to</label>
              <select
            ...
            <div class="grid grid-cols-2 gap-3">
              <div>
                <label class="block text-sm font-semibold text-navy mb-2">Min order ($)</label>
                <input
              ...
              <div>
                <label class="block text-sm font-semibold text-navy mb-2">Max discount ($)</label>
                <input
            ...
            <div>
              <label class="block text-sm font-semibold text-navy mb-2">Usage limit</label>
              <input
            ...
            <div class="grid grid-cols-2 gap-3">
              <div>
                <label class="block text-sm font-semibold text-navy mb-2">Starts at</label>
                <input
              ...
              <div>
                <label class="block text-sm font-semibold text-navy mb-2">Expires at</label>
                <input
                ...
                >
                <p v-if="errors.expires_at" class="text-red-500 text-xs mt-1">{{ errors.expires_at }}</p>
              </div>
            </div>
            ...
            <div class="flex gap-3 pt-2">
              <button
                ...
                @click="savePromoCode"
              >
                {{ isSaving ? 'Saving...' : (editingId ? 'Update' : 'Add Promo Code') }}
              </button>
              <button
                v-if="editingId"
                type="button"
      ...
      <div class="lg:col-span-7">
        <div class="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
          ...
          <div v-if="!promoCodes.length" class="p-10 text-center text-slate-400 text-sm">
            No promo codes yet.
          </div>
          ...
          >
            <div class="min-w-0">
              <strong class="text-navy text-sm font-mono">{{ promo.code }}</strong>
    ...
    >
      <div class="bg-white rounded-xl p-6 max-w-md w-full shadow-xl">
        ...
        <p class="text-slate-600 text-sm mb-6 font-mono">{{ promoToDelete?.code }}</p>
