<template>
  <div class="p-6 space-y-6 bg-slate-50 min-h-screen">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
      <!-- Form -->
      <div
        class="xl:col-span-1 bg-white rounded-xl border border-slate-100 shadow-sm p-6"
      >
      ...
      <div class="xl:col-span-2">
        ...
        >
          ...
          <template #cell-role="{ item }">
            <span
              class="px-2.5 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800 capitalize"
            >
