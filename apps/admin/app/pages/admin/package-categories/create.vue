      ...
      <div class="main-form">
        <div class="form-section">
          <label class="form-label"
            >Package Title <span class="required">*</span></label
          >
          <input
          ...
          />
          <small v-if="errors.package_title" class="error-text">{{
        ...
        <div class="form-section">
          ...
          ></textarea>
          <small v-if="errors.package_description" class="error-text">{{
        ...
        <div class="form-row">
          <div class="form-section">
            ...
            <input
              v-model="category.event_date_from"
              type="date"
              class="form-date"
            />
          </div>
          <div class="form-section">
            ...
            <input
              v-model="category.event_date_to"
              type="date"
              class="form-date"
            />
          </div>
