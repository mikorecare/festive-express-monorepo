<template>
  <div class="p-6 space-y-6 bg-slate-50 min-h-screen">
    ...
    >
      <div>
        <h1 class="text-2xl font-bold text-navy">Cookie Policy</h1>
    ...
    <form class="space-y-6" @submit.prevent="saveContent">
      ...
      >
        <h2 class="text-lg font-bold text-navy">
          Short description (cookie modal)
        </h2>
        <textarea
          v-model="form.short_description"
          rows="5"
          class="field w-full"
          placeholder="Text shown in the cookie consent popup"
        />
      </div>
      ...
      >
        ...
        <RichTextEditor
          ...
          placeholder="Write cookie policy content…"
        />
      </div>
    </form>
  </div>
