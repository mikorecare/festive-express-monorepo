  ...
  <div class="p-6 space-y-6 bg-slate-50 min-h-screen">
    ...
    >
      <div>
        ...
        <p class="text-slate-500 text-sm">
          Banner, title, description & side image
        </p>
      </div>
      <button
        type="button"
    ...
    <form class="space-y-6" @submit.prevent="saveContent">
      ...
      >
        ...
        <p class="text-slate-500 text-sm">
          Matches left column: orange intro, body text, quote block. Use the
          toolbar for bold, color, alignment.
        </p>
        <RichTextEditor
      ...
      >
        ...
        <div class="flex gap-2">
          <input
            v-model="form.description_image_url"
            type="text"
            class="field flex-1"
            placeholder="Side / oval image URL"
          />
          <label
            class="inline-flex items-center justify-center px-4 py-2 bg-navy text-white rounded-lg text-sm font-medium cursor-pointer hover:bg-slate-800 whitespace-nowrap"
          >
