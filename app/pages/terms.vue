    ...
    <div class="page-main-section container">
      <div class="legal-content">
        ...
        <p>
          ...
          <a href="http://festive.express">http://festive.express</a> website (the “Service”) operated in partnership with 
          Festive Lighting Pros (“us”, “we”, or “our”).
        </p>
        <p>
        ...
        <ul>
          ...
          <li><strong>Email:</strong> <a href="mailto:packages@festive.express">packages@festive.express</a></li>
          <li><strong>Phone:</strong> <a href="tel:+19414000306">+1 (941) 400-0306</a></li>
        </ul>
      </div>
    </div>
  </div>
